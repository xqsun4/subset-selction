"""Berthet, Quentin, et al. "Learning with differentiable pertubed optimizers." 
    Advances in neural information processing systems 33 (2020): 9508-9519.
    
    usage: compute gradient for perturbed optimizer
...
if __name__ == "__main__":
    shape = [2, 2]
    print(sample_noise_with_gradients(_GUMBEL, shape))
